...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Edoardo Debenedetti"
    user-mail-address "edoardo.debenedetti@inf.ethz.ch")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/edoardo/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/edoardo/bin" "/profile/bin" "/Users/edoardo/.npm-packages/bin" "/Users/edoardo/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
